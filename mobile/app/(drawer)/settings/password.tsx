		...
		<Card className="my-10 mx-4">
			<CardContent>
				...
				<View className="relative">
					...
					<Pressable
						onPress={() =>
							setCurrentSecureTextEntry(!secureCurrentTextEntry)
						}
				...
				<Text className="text-lg font-semibold mt-2">New Password</Text>
				<View className="relative">
					<TextInput
				...
				<View className="relative">
					...
					<Pressable
						onPress={() =>
							setConfirmSecureTextEntry(!secureConfirmTextEntry)
						}
						className="absolute right-3 top-1/3 transform -translate-y-1/3"
					>
